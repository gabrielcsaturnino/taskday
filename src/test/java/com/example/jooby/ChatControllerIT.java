...
public class ChatControllerIT { 
    ...
    void sendMessage_whenUserIsNotParticipant_shouldNotBroadcastMessage() throws Exception {
        ...
        CreateContractorRequestDTO impostorDTO = new CreateContractorRequestDTO("Impostor", "User", "555555555", "impostorPass123#", "62955555555", "impostor@gmail.com", "02920643223", "1995-05-05",  "Impostor description",address3);
