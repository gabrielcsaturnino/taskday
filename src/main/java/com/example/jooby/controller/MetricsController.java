...
public class MetricsController {
    ...
    public ResponseEntity<Map<String, Object>> getDashboardMetrics() {
        ...
        applicationStats.put("submitted", jobApplicationRepository.countByStatusApplication(com.example.jooby.job.enums.ApplicationStatusEnum.SUBMITTED));
        applicationStats.put("accepted", jobApplicationRepository.countByStatusApplication(com.example.jooby.job.enums.ApplicationStatusEnum.ACCEPTED));
        applicationStats.put("rejected", jobApplicationRepository.countByStatusApplication(com.example.jooby.job.enums.ApplicationStatusEnum.REJECTED));
    ...
    public ResponseEntity<Map<String, Object>> getActiveJobsMetrics() {
        ...
        long activeJobs = jobRepository.countByJobStatus(com.example.jooby.job.enums.JobStatusEnum.active);
        long inactiveJobs = jobRepository.countByJobStatus(com.example.jooby.job.enums.JobStatusEnum.inactive);
